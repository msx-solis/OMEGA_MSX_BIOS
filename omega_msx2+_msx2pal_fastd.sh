# this script generates a international version of msx2+ and msx2pal with cdx2 support
# it has international keys with ntsc & pal
#!/bin/bash

#both parts include fastdrom_cdx2-1.1

OUTPUT_FILE=omega_msx2+_msx2pal_fastd.bin
...
dd if=/dev/zero ibs=1k count=16 | tr "\000" "\377" >> ${OUTPUT_FILE} #16k - 224k (FM)
cat ${SYSTEM_ROMS_DIR}/phc-70fd2_basickun.rom >> ${OUTPUT_FILE} #16k - 240 k
